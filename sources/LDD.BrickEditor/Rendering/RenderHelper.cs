...
namespace LDD.BrickEditor.Rendering
{
    public static class RenderHelper
    {
        ...
        public static void DrawStudConnectorGrid(Matrix4 transform, LDD.Core.Primitives.Connectors.Custom2DFieldConnector connector)
        {
        ...
        //public static void DrawStudConnector(Matrix4 transform, LDD.Core.Primitives.Connectors.Custom2DFieldConnector connector)
        //{
