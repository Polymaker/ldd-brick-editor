namespace LDD.BrickEditor.UI.Controls
{
    partial class TransformEditor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PosX_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
            this.PosY_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
            this.PosZ_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
            this.RotX_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
            this.RotY_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
            this.RotZ_TextBox = new LDD.BrickEditor.UI.Controls.NumberTextBox();
