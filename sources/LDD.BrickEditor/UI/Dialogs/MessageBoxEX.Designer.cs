namespace LDD.BrickEditor.UI.Windows
{
    partial class MessageBoxEX
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ButtonLabels = new LDD.BrickEditor.Localization.LocalizableStringList(this.components);
            this.Label_OK = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_Cancel = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_Yes = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_No = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_Abort = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_Retry = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            this.Label_Ignore = ((LDD.BrickEditor.Localization.LocalizableString)(new LDD.BrickEditor.Localization.LocalizableString()));
            ...
            // ButtonLabels
            // 
            this.ButtonLabels.Items.AddRange(new LDD.BrickEditor.Localization.LocalizableString[] {
            this.Label_OK,
            this.Label_Cancel,
            this.Label_Yes,
            this.Label_No,
