namespace LDD.BrickEditor.UI.Windows
{
    partial class MessageBoxEX
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Label_OK = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_Cancel = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_Yes = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_No = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_Abort = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_Retry = new LDD.BrickEditor.Localization.LocalizableString();
            this.Label_Ignore = new LDD.BrickEditor.Localization.LocalizableString();
