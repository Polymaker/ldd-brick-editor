    ...
    public partial class ImportModelsDialog : Form
    {
        ...
        private List<BoneMapping> GetBoneMappings()
        {
            ...
            foreach (var boneNode in boneNodes)
            {
                ...
                //boneTransform = Common.Simple3D.Matrix4.FromAngleAxis((float)Math.PI * -0.5f, yAxis) * boneTransform;
            ...
            foreach (var bone in bones)
            {
                ...
                if (target != null)
                {
                    ...
                    var angle = Vector3d.AngleBetween(Vector3d.UnitX, dir);
                    var yAxis = Vector3d.Cross(Vector3d.UnitX, dir);
                    var rot = Matrix4d.FromAngleAxis(angle, yAxis);
