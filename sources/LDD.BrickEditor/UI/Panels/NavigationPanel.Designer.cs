namespace LDD.BrickEditor.UI.Panels
{
    partial class NavigationPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LocalizedStrings = new LDD.BrickEditor.Localization.LocalizableStringList(this.components);
            this.ViewModeAll = new LDD.BrickEditor.Localization.LocalizableString();
            this.ViewModeBones = new LDD.BrickEditor.Localization.LocalizableString();
            this.ViewModeCollisions = new LDD.BrickEditor.Localization.LocalizableString();
            this.ViewModeConnections = new LDD.BrickEditor.Localization.LocalizableString();
            this.ViewModeSurfaces = new LDD.BrickEditor.Localization.LocalizableString();
            ...
            // LocalizedStrings
            // 
            this.LocalizedStrings.Items.AddRange(new LDD.BrickEditor.Localization.LocalizableString[] {
            this.ViewModeAll,
            this.ViewModeBones,
