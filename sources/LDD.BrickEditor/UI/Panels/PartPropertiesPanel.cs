    ...
    public partial class PartPropertiesPanel : ProjectDocumentPanel
    {
        ...
        private void UpdateControlBindings()
        {
            ...
            else
            {
                ...
                BoundingEditor.Value = new Core.Primitives.BoundingBox();
                GeomBoundingEditor.Value = new Core.Primitives.BoundingBox();
                CenterOfMassEditor.Value = Common.Simple3D.Vector3d.Zero;
            }
        ...
        private void FillInertiaTensor(Common.Simple3D.Matrix3d matrix)
        {
        ...
        private void InertiaTensorTextBox_Validated(object sender, EventArgs e)
        {
            ...
            {
                var inertiaMatrix = new Common.Simple3D.Matrix3d();
