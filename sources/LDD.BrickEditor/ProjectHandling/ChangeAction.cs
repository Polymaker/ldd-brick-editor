            ...
            if (propInfo != null)
            {
                if (Data.Index != null)
                {
                    ...
                    if (Data.Index.Length == 2 &&
                        objToAssign is Core.Primitives.Connectors.Custom2DFieldConnector connector)
                    {
                        connector.SetValue(Data.Index[0], Data.Index[1], (Core.Primitives.Connectors.Custom2DFieldValue)value);
                        return;
                    }
